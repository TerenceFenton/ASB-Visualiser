...
```{r}
saveChange <- sum(bigDF$Amount[bigDF$Memo == "SAVETHECHANG E"])
saveChange

sum(bigDF$Amount[bigDF$Payee == "ASB BANK - INTEREST"]) - 
  max(bigDF$Amount[bigDF$Payee == "ASB BANK - INTEREST"]) -
  sum(bigDF$Amount[bigDF$Payee ==  "IRD:TAX ON INTEREST"])
```
